...
window.addEventListener('popstate', function () {
    ...
    if (currentPath.includes('/pages/employer-dashboard.html') ||
        currentPath.includes('/pages/employer-new-job.html') ||
        currentPath.includes('/pages/employer-job-listings.html')) {
